...
final class QuoteMediaError {
    ...
    private function __construct() {
        $this->data = array(
            ...
            QuoteMediaError::INPUT_IS_NOT_ARRAY => 'You did not pass the library function an array on your last function call. Functions like getQuote expect an array as the first parameter.',
